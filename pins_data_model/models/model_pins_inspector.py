...
#   timestamp: 2025-10-30T10:04:24+00:00
...
class PinsInspector(BaseModel):
    ...
    """
    unit: str = Field(..., examples=["Corporate Services"])
    """
    The personnel area of the Inspector
    """
    service: str = Field(..., examples=["Ops Group 1"])
    """
    The personnel sub area of the Inspector
    """
    group: str = Field(..., examples=["Case Management (Local Plans/Inq/Costs)"])
    """
