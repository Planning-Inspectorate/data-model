...
| [finalCommentsDueDate](#finalcommentsduedate)                                                       | `string`  | Optional | can be null    | [Appeal S78 Case](appeal-s78-properties-finalcommentsduedate.md "appeal-s78.schema.json#/properties/finalCommentsDueDate")                                                       |
| [interestedPartyRepsDueDate](#interestedpartyrepsduedate)                                           | `string`  | Optional | can be null    | [Appeal S78 Case](appeal-s78-properties-interestedpartyrepsduedate.md "appeal-s78.schema.json#/properties/interestedPartyRepsDueDate")                                           |
...
| [proofsOfEvidenceDueDate](#proofsofevidenceduedate)                                                 | `string`  | Optional | can be null    | [Appeal S78 Case](appeal-s78-properties-proofsofevidenceduedate.md "appeal-s78.schema.json#/properties/proofsOfEvidenceDueDate")                                                 |
...
| [statementDueDate](#statementduedate)                                                               | `string`  | Optional | can be null    | [Appeal S78 Case](appeal-s78-properties-statementduedate.md "appeal-s78.schema.json#/properties/statementDueDate")                                                               |
...
| [reasonForAppealAppellant](#reasonforappealappellant)                                               | `string`  | Optional | can be null    | [Appeal S78 Case](appeal-s78-properties-reasonforappealappellant.md "appeal-s78.schema.json#/properties/reasonForAppealAppellant")                                               |
| [screeningOpinionIndicatesEiaRequired](#screeningopinionindicateseiarequired)                       | `boolean` | Optional | can be null    | [Appeal S78 Case](appeal-s78-properties-screeningopinionindicateseiarequired.md "appeal-s78.schema.json#/properties/screeningOpinionIndicatesEiaRequired")                       |
| [significantChangesAffectingApplicationAppellant](#significantchangesaffectingapplicationappellant) | `array`   | Optional | can be null    | [Appeal S78 Case](appeal-s78-properties-significantchangesaffectingapplicationappellant.md "appeal-s78.schema.json#/properties/significantChangesAffectingApplicationAppellant") |
| [significantChangesAffectingApplicationLpa](#significantchangesaffectingapplicationlpa)             | `array`   | Optional | can be null    | [Appeal S78 Case](appeal-s78-properties-significantchangesaffectingapplicationlpa.md "appeal-s78.schema.json#/properties/significantChangesAffectingApplicationLpa")             |
...
* defined in: [Appeal S78 Case](appeal-s78-properties-listofdocumentsbeforedecision.md "appeal-s78.schema.json#/properties/listOfDocumentsBeforeDecision")
...
* defined in: [Appeal S78 Case](appeal-s78-properties-reasonforappealappellant.md "appeal-s78.schema.json#/properties/reasonForAppealAppellant")

### reasonForAppealAppellant Type
...
* defined in: [Appeal S78 Case](appeal-s78-properties-screeningopinionindicateseiarequired.md "appeal-s78.schema.json#/properties/screeningOpinionIndicatesEiaRequired")

### screeningOpinionIndicatesEiaRequired Type
...
* Type: `object[]` ([Details](appeal-s78-properties-significantchangesaffectingapplicationappellant-items.md))

* can be null

* defined in: [Appeal S78 Case](appeal-s78-properties-significantchangesaffectingapplicationappellant.md "appeal-s78.schema.json#/properties/significantChangesAffectingApplicationAppellant")

### significantChangesAffectingApplicationAppellant Type

`object[]` ([Details](appeal-s78-properties-significantchangesaffectingapplicationappellant-items.md))
...
* Type: `object[]` ([Details](appeal-s78-properties-significantchangesaffectingapplicationlpa-items.md))

* can be null

* defined in: [Appeal S78 Case](appeal-s78-properties-significantchangesaffectingapplicationlpa.md "appeal-s78.schema.json#/properties/significantChangesAffectingApplicationLpa")

### significantChangesAffectingApplicationLpa Type

`object[]` ([Details](appeal-s78-properties-significantchangesaffectingapplicationlpa-items.md))
