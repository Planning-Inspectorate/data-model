...
| [publishedStatus](#publishedstatus)           | `boolean` | Required | cannot be null | [Appeal Document](appeal-document-properties-publishedstatus.md "appeal-document.schema.json#/properties/publishedStatus")           |
...
> Consumers should expose documents that are published, and have a suitable redaction status
...
*   defined in: [Appeal Document](appeal-document-properties-publishedstatus.md "appeal-document.schema.json#/properties/publishedStatus")
