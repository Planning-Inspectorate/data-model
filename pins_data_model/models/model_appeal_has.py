...
#   timestamp: 2025-09-09T11:38:23+00:00
...
class AppealHasCase1(BaseModel):
    ...
    """
    advertType: str | None = None


class NotificationMethodEnum1EnumEnum(Enum):
    notice = "notice"
    letter = "letter"
    advert = "advert"


class NotificationMethodEnum1(RootModel[NotificationMethodEnum1EnumEnum | None]):
    root: NotificationMethodEnum1EnumEnum | None = None
...
class AppealHasCase2(BaseModel):
    ...
    Indicates if the appellant has advertised the appeal to the LPA decision
    """
    notificationMethod: list[NotificationMethodEnum1]
    """
    The methods used to notify relevant parties
    """
    ownersInformed: bool | None = None
