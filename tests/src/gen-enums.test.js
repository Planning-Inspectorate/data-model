...
import { collectEnumProps, formatName, generateConstants, schemaPrefix } from "../../src/gen-enums.js"
...
describe("gen-enums.js", () => {
    describe('generateConstants', () => {
        it('should generate JS code for exported constants', () => {
            ...
            const expectedOutput = `export const TEST_ENUM = Object.freeze({\r\n  VALUE_1: 'value1',\r\n  VALUE_2: 'value2',\r\n});`;
        ...
        it('should generate TS code for exported constants', () => {
            const name = 'TestEnum';
            const values = ['value1', 'value2'];
            const expectedOutput = `export const TEST_ENUM = {\r\n  VALUE_1: 'value1',\r\n  VALUE_2: 'value2',\r\n};`;
        ...
        it('should sort values before generating constants', () => {
            ...
            const expectedOutput = `export const UNSORTED_ENUM = Object.freeze({\r\n  VALUE_1: 'value1',\r\n  VALUE_2: 'value2',\r\n});`;
        ...
        it('should handle single value in the array', () => {
            ...
            const values = ['value1'];
            const expectedOutput = `export const SINGLE_ENUM = Object.freeze({\r\n  VALUE_1: 'value1',\r\n});`;
