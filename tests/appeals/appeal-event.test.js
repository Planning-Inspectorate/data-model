...
describe(schema, () => {
    ...
    it('should allow valid event schema with only required fields', () => {
        const test = structuredClone(event);
        delete test.addressLine1;
        delete test.addressLine2;
        delete test.addressTown;
        delete test.addressCounty;
        delete test.addressPostcode;
