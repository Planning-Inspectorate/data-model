...
#   timestamp: 2024-08-09T09:05:39+00:00
...
class AppealS78Case(BaseModel):
    ...
    """
    appellantFinalCommentDetails: str | None = None
    """
    The final comments details indicated by the appellant
    """
    appellantWitnesses: bool | None = None
    """
    ...
    """
    hasConsultationResponses: bool | None = None
    """
    Indicates consultation responses
    """
    hasEmergingPlan: bool | None = None
    """
    Indicates emerging plans
    """
    hasSupplementaryPlanningDocs: bool | None = None
    """
    ...
    """
    lpaFinalCommentDetails: str | None = None
    """
    The final comments details indicated by the LPA
    """
    lpaAddedWitnesses: bool | None = None
    """
    ...
    appellantCommentsSubmitted: AwareDatetime | None = Field(
        ..., examples=["2023-07-27T20:30:00.000Z"]
    )
    appellantStatementSubmitted: AwareDatetime | None = Field(
        ..., examples=["2023-07-27T20:30:00.000Z"]
    )
    ...
    lpaCommentsSubmitted: AwareDatetime | None = Field(
        ..., examples=["2023-07-27T20:30:00.000Z"]
    )
    lpaProofsSubmitted: AwareDatetime | None = Field(
        ..., examples=["2023-07-27T20:30:00.000Z"]
    )
    lpaStatementSubmitted: AwareDatetime | None = Field(
        ..., examples=["2023-07-27T20:30:00.000Z"]
    )
    proofsOfEvidenceDueDate: AwareDatetime | None = Field(
        ..., examples=["2023-07-27T20:30:00.000Z"]
    )
    siteNoticesSent: AwareDatetime | None = Field(
        ..., examples=["2023-07-27T20:30:00.000Z"]
    )
    statementDueDate: AwareDatetime | None = Field(
        ..., examples=["2023-07-27T20:30:00.000Z"]
    )
    inspectorNeedToEnterSite: bool | None = None
    numberOfResidences: float | None = None
    """
