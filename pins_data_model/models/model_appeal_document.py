...
class DocumentType(Enum):
    ...
    conservationDocuments = "conservationDocuments"
    planShowingExtentOfOrder = "planShowingExtentOfOrder"
    definitiveMapAndStatementExtract = "definitiveMapAndStatementExtract"
    stopNotice = "stopNotice"
    article4Direction = "article4Direction"
    enforcementList = "enforcementList"
    localDevelopmentOrder = "localDevelopmentOrder"
    planningPermission = "planningPermission"
    lpaEnforcementNotice = "lpaEnforcementNotice"
    lpaEnforcementNoticePlan = "lpaEnforcementNoticePlan"
    lpaEnforcementNoticeWithdrawal = "lpaEnforcementNoticeWithdrawal"
    planningContraventionNotice = "planningContraventionNotice"
    priorCorrespondenceWithPINS = "priorCorrespondenceWithPINS"
    enforcementNotice = "enforcementNotice"
    enforcementNoticePlan = "enforcementNoticePlan"
    groundASupporting = "groundASupporting"
    groundBSupporting = "groundBSupporting"
    groundCSupporting = "groundCSupporting"
    groundDSupporting = "groundDSupporting"
    groundESupporting = "groundESupporting"
    groundFSupporting = "groundFSupporting"
    groundGSupporting = "groundGSupporting"
    groundAFeeReceipt = "groundAFeeReceipt"
    delegatedReport = "delegatedReport"
    relatedApplications = "relatedApplications"
    otherRelevantMatters = "otherRelevantMatters"
    groundHSupporting = "groundHSupporting"
    groundISupporting = "groundISupporting"
    groundJSupporting = "groundJSupporting"
    groundKSupporting = "groundKSupporting"
    discontinuanceNotice = "discontinuanceNotice"
    otherSupportingInformationAppellant = "otherSupportingInformationAppellant"
    eiaEnvironmentalStatementAppellant = "eiaEnvironmentalStatementAppellant"
    NoneType_None = None
