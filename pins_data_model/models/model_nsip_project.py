...
class Meeting(BaseModel):
    ...
    meetingId: int = Field(..., examples=[123])
    """
...
class InvoiceStage(RootModel[InvoiceStageEnum | None]):
    root: InvoiceStageEnum | None = Field(None, examples=["pre_acceptance"])
    """
    Invoice stage
    """
...
class Invoice(BaseModel):
    ...
    Invoice number
    """
    amountDue: float | None = Field(..., examples=[500])
    """
    Amount due
    """
