...
export const APPEAL_UNDER_ACT_SECTION = {
...
export const APPLICATION_EIA_SCREENING_OUTCOME = {
  NOT_REQUIRED: 'not required',
  REQUIRED: 'required',
} as const;

export const APPLICATION_EMAIL_STATUS = {
  DELIVERED: 'Delivered',
...
export const APPLICATION_REPRESENTATION_STATUS = {
  ACCEPTED: 'Accepted',
...
export const APPLICATION_REPRESENTED_CATEGORY = {
  CONSULTEES: 'Consultees',
  INTERESTED_PARTY: 'Interested party',
} as const;

export const APPLICATION_REPRESENTED_TYPE = {
  A_PERSON: 'A person',
...
export const APPLICATION_WITHDRAWAL_REASON = {
...
export const NSIP_MEETING_TYPE = {
