...
| [reasonForAppealAppellant](#reasonforappealappellant)                                               | `string`  | Optional | can be null    | [Appeal HAS Case](appeal-has-properties-reasonforappealappellant.md "appeal-has.schema.json#/properties/reasonForAppealAppellant")                                               |
| [significantChangesAffectingApplicationAppellant](#significantchangesaffectingapplicationappellant) | `array`   | Optional | can be null    | [Appeal HAS Case](appeal-has-properties-significantchangesaffectingapplicationappellant.md "appeal-has.schema.json#/properties/significantChangesAffectingApplicationAppellant") |
| [significantChangesAffectingApplicationLpa](#significantchangesaffectingapplicationlpa)             | `array`   | Optional | can be null    | [Appeal HAS Case](appeal-has-properties-significantchangesaffectingapplicationlpa.md "appeal-has.schema.json#/properties/significantChangesAffectingApplicationLpa")             |
...
* defined in: [Appeal HAS Case](appeal-has-properties-reasonforappealappellant.md "appeal-has.schema.json#/properties/reasonForAppealAppellant")
...
* Type: `object[]` ([Details](appeal-has-properties-significantchangesaffectingapplicationappellant-items.md))

* can be null

* defined in: [Appeal HAS Case](appeal-has-properties-significantchangesaffectingapplicationappellant.md "appeal-has.schema.json#/properties/significantChangesAffectingApplicationAppellant")

### significantChangesAffectingApplicationAppellant Type

`object[]` ([Details](appeal-has-properties-significantchangesaffectingapplicationappellant-items.md))
...
* Type: `object[]` ([Details](appeal-has-properties-significantchangesaffectingapplicationlpa-items.md))

* can be null

* defined in: [Appeal HAS Case](appeal-has-properties-significantchangesaffectingapplicationlpa.md "appeal-has.schema.json#/properties/significantChangesAffectingApplicationLpa")

### significantChangesAffectingApplicationLpa Type

`object[]` ([Details](appeal-has-properties-significantchangesaffectingapplicationlpa-items.md))

## Additional Properties

Additional properties are allowed and do not have to follow a specific schema

# Appeal HAS Case Definitions
...
```json
{"$ref":"appeal-has.schema.json#/definitions/SignificantChangesAffectingApplication"}
```
