...
export const APPEAL_HAS_TYPE_OF_PLANNING_APPLICATION = Object.freeze({
...
export const APPEAL_APPLICATION_MADE_UNDER_ACT_SECTION = Object.freeze({
  EXISTING_DEVELOPMENT: 'existing-development',
  PROPOSED_CHANGES_TO_A_LISTED_BUILDING: 'proposed-changes-to-a-listed-building',
  PROPOSED_USE_OF_A_DEVELOPMENT: 'proposed-use-of-a-development',
});
...
export const APPEAL_DEVELOPMENT_TYPE = Object.freeze({
...
export const APPEAL_DISCONTINUANCE_NOTICE_SERVED_REASON = Object.freeze({
...
export const APPEAL_TYPE_OF_PLANNING_APPLICATION = Object.freeze({
  ADVERTISEMENT: 'advertisement',
...
export const NSIP_PROJECT_SOURCE_SYSTEM = Object.freeze({
...
export const NSIP_INVOICE_STAGE = Object.freeze({
  ACCEPTANCE: 'acceptance',
...
export const NSIP_PLANNING_INSPECTORATE_ROLE = Object.freeze({
  ADVISOR: 'advisor',
