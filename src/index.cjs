...
const APPEAL_HAS_TYPE_OF_PLANNING_APPLICATION = Object.freeze({
...
const APPEAL_DISCONTINUANCE_NOTICE_SERVED_REASON = Object.freeze({
...
const APPEAL_DOCUMENT_TYPE = Object.freeze({
  ...
  ARTICLE_4_DIRECTION: 'article4Direction',
  ...
  CONSERVATION_DOCUMENTS: 'conservationDocuments',
  ...
  DEFINITIVE_MAP_AND_STATEMENT_EXTRACT: 'definitiveMapAndStatementExtract',
  ...
  ENFORCEMENT_LIST: 'enforcementList',
  ...
  GENERAL_SUPPORTING: 'generalSupporting',
  GROUND_A_FEE_RECEIPT: 'groundAFeeReceipt',
  GROUND_A_SUPPORTING: 'groundASupporting',
  GROUND_B_SUPPORTING: 'groundBSupporting',
  GROUND_C_SUPPORTING: 'groundCSupporting',
  GROUND_D_SUPPORTING: 'groundDSupporting',
  GROUND_E_SUPPORTING: 'groundESupporting',
  GROUND_F_SUPPORTING: 'groundFSupporting',
  GROUND_G_SUPPORTING: 'groundGSupporting',
  GROUND_H_SUPPORTING: 'groundHSupporting',
  GROUND_I_SUPPORTING: 'groundISupporting',
  GROUND_J_SUPPORTING: 'groundJSupporting',
  GROUND_K_SUPPORTING: 'groundKSupporting',
  HEARING_PROCESS: 'hearingProcess',
  HISTORIC_ENGLAND_CONSULTATION: 'historicEnglandConsultation',
  INQUIRY_CORE: 'inquiryCore',
  INQUIRY_POST_EVENT: 'inquiryPostEvent',
  INSPECTOR_CORRESPONDENCE: 'inspectorCorrespondence',
  INTERESTED_PARTY_COMMENT: 'interestedPartyComment',
  LOCAL_DEVELOPMENT_ORDER: 'localDevelopmentOrder',
...
const APPLICATION_UPDATE_STATUS = Object.freeze({
  DRAFT: 'Draft',
  PUBLISHED: 'Published',
  UNPUBLISHED: 'Unpublished',
});

const APPLICATION_CATEGORY = Object.freeze({
...
const APPLICATION_DECISION_OUTCOME = Object.freeze({
  APPROVED: 'Approved',
...
const APPLICATION_EIA_SCREENING_OUTCOME = Object.freeze({
  NOT_REQUIRED: 'not required',
  REQUIRED: 'required',
});

const APPLICATION_EMAIL_STATUS = Object.freeze({
  DELIVERED: 'Delivered',
...
const APPLICATION_PROCEDURE = Object.freeze({
  HEARING: 'Hearing',
  INQUIRY: 'Inquiry',
  WRITTEN_REPRESENTATIONS: 'Written Representations',
});

const APPLICATION_REPRESENTATION_STATUS = Object.freeze({
  ACCEPTED: 'Accepted',
...
const APPLICATION_REPRESENTED_CATEGORY = Object.freeze({
  CONSULTEES: 'Consultees',
  INTERESTED_PARTY: 'Interested party',
});

const APPLICATION_REPRESENTED_TYPE = Object.freeze({
  A_PERSON: 'A person',
...
const APPLICATION_WITHDRAWAL_REASON = Object.freeze({
...
const NSIP_INVOICE_STAGE = Object.freeze({
  ACCEPTANCE: 'acceptance',
...
const NSIP_MEETING_TYPE = Object.freeze({
...
const NSIP_PLANNING_INSPECTORATE_ROLE = Object.freeze({
  ADVISOR: 'advisor',
...
exports.APPEAL_DISCONTINUANCE_NOTICE_SERVED_REASON = APPEAL_DISCONTINUANCE_NOTICE_SERVED_REASON;
...
exports.APPEAL_HAS_TYPE_OF_PLANNING_APPLICATION = APPEAL_HAS_TYPE_OF_PLANNING_APPLICATION;
...
exports.APPLICATION_CATEGORY = APPLICATION_CATEGORY;
exports.APPLICATION_DECISION_OUTCOME = APPLICATION_DECISION_OUTCOME;
exports.APPLICATION_EIA_SCREENING_OUTCOME = APPLICATION_EIA_SCREENING_OUTCOME;
exports.APPLICATION_EMAIL_STATUS = APPLICATION_EMAIL_STATUS;
exports.APPLICATION_PROCEDURE = APPLICATION_PROCEDURE;
exports.APPLICATION_REPRESENTATION_STATUS = APPLICATION_REPRESENTATION_STATUS;
exports.APPLICATION_REPRESENTED_CATEGORY = APPLICATION_REPRESENTED_CATEGORY;
exports.APPLICATION_REPRESENTED_TYPE = APPLICATION_REPRESENTED_TYPE;
exports.APPLICATION_STAGE = APPLICATION_STAGE;
exports.APPLICATION_STATUS = APPLICATION_STATUS;
exports.APPLICATION_SUBMITTED_FOR = APPLICATION_SUBMITTED_FOR;
exports.APPLICATION_SUBMITTED_RECEIVED_METHOD = APPLICATION_SUBMITTED_RECEIVED_METHOD;
exports.APPLICATION_SUB_TYPE = APPLICATION_SUB_TYPE;
exports.APPLICATION_TYPE = APPLICATION_TYPE;
exports.APPLICATION_UPDATE_STATUS = APPLICATION_UPDATE_STATUS;
exports.APPLICATION_WITHDRAWAL_REASON = APPLICATION_WITHDRAWAL_REASON;
...
exports.NSIP_INVOICE_STAGE = NSIP_INVOICE_STAGE;
...
exports.NSIP_MEETING_TYPE = NSIP_MEETING_TYPE;
